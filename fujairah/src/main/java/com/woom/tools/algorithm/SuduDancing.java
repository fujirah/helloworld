...
public class SuduDancing {
        ...
        for(int i = 0;i < 81;i++){
            ...
            if(0 == num){
                for(int addNum=1;addNum<=9;addNum++){
                    ...
                    link4(x,y,rowAdd,addNum,C1,C2,C3,C4);
                    rowAdd ++;
                }
            }else{
                C1 = i;
                ...
                link4(x,y,rowAdd,num,C1,C2,C3,C4);
                rowAdd ++;
            }
        }
    ...
    //横向连接
    public void link4(int x,int y,int row,Integer value,Integer he,Integer... clumIndex){
